...
//            sChannel.write(ByteBuffer.wrap(("0").getBytes()));
//            fileSending = false;
//            return;
//        }
//        if (!fileSending) {
...
//            fromFileStream = new FileInputStream("file");//http://www.programcreek.com/java-api-examples/index.php?source_dir=my-ministry-assistant-master/src/com/myMinistry/util/FileUtils.java
//            fChannel = fromFileStream.getChannel();
//            System.out.print("\nfile size: " + fChannel.size());
//            sChannel.write(ByteBuffer.wrap(("" + fChannel.size()).getBytes()));
//            System.out.println(".STARTING");
//            return;
//        }
//
//        do {
//            bytesSent = fChannel.transferTo(fChannel.position(), BUFFER_SIZE, sChannel);
//            bytesCount += bytesSent;
//            System.out.println("." + bytesCount + " bytes sent pos=" + fChannel.position() + " sent" + bytesSent);
//            fChannel.position(bytesCount);
//        }
//        while (bytesSent > 0 && false);
//
